...
static const char* ToString(const Keynum keynum)
{
    switch(keynum)
    {
    default:
...
static const Chord chords[] = {
    ...
    { "F5        or   F(no 3rd)  ", "[x 8 10 10 x x]", "(C  F)", "root and 5th (power chord)" },
...
{
#define LAYOUT { "I", "II", "III", "IV", "V", "VI", "VII" }, { "i", "ii", "iii", "iv", "v", "vi", "vii" }
    switch(keynum)
    {
    default:
    case KEY_A:       return (Key) { LAYOUT, { "Amaj",  "Bmaj",  "Dbmaj", "Dmaj",  "Emaj",  "Abmaj", "Abmaj" }, { "Am",  "Bm",  "Dbm", "Dm",  "Em",  "Gbm", "Em"  } };
    case KEY_A_SHARP: return (Key) { LAYOUT, { "Bbmaj", "Cmaj",  "Dmaj",  "Ebmaj", "Fmaj",  "Gmaj",  "Amaj"  }, { "Bbm", "Cm",  "Dm",  "Ebm", "Fm",  "Gm",  "Am"  } };
    case KEY_B:       return (Key) { LAYOUT, { "Bmaj",  "Dbmaj", "Ebmaj", "Emaj",  "Abmaj", "Abmaj", "Bbmaj" }, { "Bm",  "Dbm", "Ebm", "Em",  "Gbm", "Em", "Bbm"  } };
    case KEY_C:       return (Key) { LAYOUT, { "Cmaj",  "Dmaj",  "Emaj",  "Fmaj",  "Gmaj",  "Amaj",  "Bmaj"  }, { "Cm",  "Dm",  "Em",  "Fm",  "Gm",  "Am",  "Bm"  } };
    case KEY_C_SHARP: return (Key) { LAYOUT, { "Dbmaj", "Ebmaj", "Fmaj",  "Gbmaj", "Abmaj", "Bbmaj", "Cmaj"  }, { "Dbm", "Ebm", "Fm",  "Gbm", "Em",  "Bbm", "Cm"  } };
    case KEY_D:       return (Key) { LAYOUT, { "Dmaj",  "Emaj",  "Gbmaj", "Gmaj",  "Amaj",  "Bmaj",  "Dbmaj" }, { "Dm",  "Em",  "Gbm", "Gm",  "Am",  "Bm",  "Dbm" } };
    case KEY_D_SHARP: return (Key) { LAYOUT, { "Ebmaj", "Fmaj",  "Gmaj",  "Abmaj", "Bbmaj", "Cmaj",  "Dmaj"  }, { "Ebm", "Fm",  "Gm",  "Em",  "Bbm", "Cm",  "Dm"  } };
    case KEY_E:       return (Key) { LAYOUT, { "Emaj",  "Gbmaj", "Abmaj", "Amaj",  "Bmaj",  "Dbmaj", "Ebmaj" }, { "Em",  "Gbm", "Em",  "Am",  "Bm",  "Dbm", "Ebm" } };
    case KEY_F:       return (Key) { LAYOUT, { "Fmaj",  "Gmaj",  "Amaj",  "Bbmaj", "Cmaj",  "Dmaj",  "Emaj"  }, { "Fm",  "Gm",  "Am",  "Bbm", "Cm",  "Dm",  "Em"  } };
    case KEY_F_SHARP: return (Key) { LAYOUT, { "Gbmaj", "Abmaj", "Bbmaj", "Bmaj",  "Dbmaj", "Ebmaj", "Fmaj"  }, { "Gbm", "Em",  "Bbm", "Bm",  "Dbm", "Ebm", "Fm"  } };
    case KEY_G:       return (Key) { LAYOUT, { "Gmaj",  "Amaj",  "Bmaj",  "Cmaj",  "Dmaj",  "Emaj",  "Gbmaj" }, { "Gm",  "Am",  "Bm",  "Cm",  "Dm",  "Em",  "Gbm" } };
    case KEY_G_SHARP: return (Key) { LAYOUT, { "Abmaj", "Bbmaj", "Cmaj",  "Dbmaj", "Ebmaj", "Fmaj",  "Gmaj"  }, { "Abm", "Bbm", "Cm",  "Dbm", "Ebm", "Fm",  "Gm"  } };	
    }
#undef LAYOUT
}
...
static const char* ToQuery(const char* const roman, const Keynum keynum)
{
    const Key key = Get(keynum);
    for(int i = 0; i < LEN(key.upper); i++) if(strcmp(key.upper[i], roman) == 0) return key.major[i];
    for(int i = 0; i < LEN(key.lower); i++) if(strcmp(key.lower[i], roman) == 0) return key.minor[i];
    return "N/A";
}

static int indices[LEN(chords)];

static int Query(const char* const query)
{
    int count = 0;
    for(int i = 0; i < LEN(chords); i++)
        if(strstr(chords[i].name, query))
            indices[count++] = i;
    return count;
}
...
static Chord Choose(const char* const query)
{
    ...
    const int index = indices[pick];
    return chords[index];
}

static void Dump(const Progression prog)
{
    for(int i = 0; i < prog.count; i++)
        printf("%s ", prog.roman[i]);
    putchar('\n');
}
...
static void Generate(void)
{
    ...
    for(int i = 0; i < prog.count; i++)
    {
        const char* const query = ToQuery(prog.roman[i], keynum);
        const Chord chord = Choose(query);
        Print(chord);
    }
}
